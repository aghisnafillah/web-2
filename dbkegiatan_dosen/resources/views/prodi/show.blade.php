                    ...
                    <div class="container mt-4">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>{{ $prodi->nam }} ({{ $prodi->kode }})</h3>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <p><strong>Ketua Prodi:</strong> {{ $prodi->ketua ?? '-' }}</p>
                                        <p><strong>Telepon:</strong> {{ $prodi->telpon ?? '-' }}</p>
                                    </div>
                                    <div class="col-md-6">
                                        <p><strong>Alamat:</strong> {{ $prodi->alamat ?? '-' }}</p>
                                    </div>
                                </div>
                                ...
                                @if($prodi->dosen->count() > 0)
                                    <div class="table-responsive">
                                        <table class="table table-sm">
                                            ...
                                            <tbody>
                                                @foreach($prodi->dosen as $d)
                                                    <tr>
                                                        <td>{{ $d->nidn }}</td>
                                                        <td>{{ $d->gelar_depan }} {{ $d->nam }}
                                                            {{ $d->gelar_belakang }}</td>
                                                        <td>{{ $d->email ?? '-' }}</td>
                                                    </tr>
                                                @endforeach
                                ...
                                @else
                                    <p>Belum ada dosen yang terdaftar di prodi ini.</p>
                                @endif
                            </div>
