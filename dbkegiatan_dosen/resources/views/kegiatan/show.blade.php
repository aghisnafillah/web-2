                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8">{{ $kegiatan->jenis_kegiatan->name }}</div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-4 font-weight-bold">Periode:</div>
                                            <div class="col-md-8">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8">{{ $kegiatan->tempat }}</div>
                                        </div>

                                        <hr>

                                        <h5 class="mb-3">Dosen Peserta</h5>
                                        @if($kegiatan->dosen->count() > 0)
                                            <div class="table-responsive">
                                                <table class="table table-sm table-bordered">
                                                    ...
                                                    <tbody>
                                                        @foreach($kegiatan->dosen as $d)
                                                            <tr>
                                                                <td>{{ $loop->iteration }}</td>
                                                                <td>{{ $d->nidn }}</td>
                                                                <td>
                                                                    {{ $d->gelar_depan }} {{ $d->name }}
                                                                    {{ $d->gelar_belakang }}
                                                                </td>
                                                                <td>{{ $d->prodi->name ?? '-' }}</td>
                                                            </tr>
                                        ...
                                        @else
                                            <div class="alert alert-info">Belum ada dosen yang terdaftar dalam kegiatan ini.
                                            </div>
                                        @endif
                                    </div>
                                </div>
