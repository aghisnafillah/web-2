                            ...
                            <div class="card-body">
                                <form action="{{ route('penelitian.update', $penelitian->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="judul" id="judul" class="form-control" rows="3"
                                            required>{{ $penelitian->judul }}</textarea>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="mulai" id="mulai" class="form-control"
                                                    value="{{ $penelitian->mulai }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="akhir" id="akhir" class="form-control"
                                                    value="{{ $penelitian->akhir }}" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tahun_ajaran" id="tahun_ajaran" class="form-control"
                                            value="{{ $penelitian->tahun_ajaran }}" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="bidang_ilmu_id" id="bidang_ilmu_id" class="form-control" required>
                                            ...
                                            @foreach($bidangIlmu as $item)
                                                <option value="{{ $item->id }}" {{ $penelitian->bidang_ilmu_id == $item->id ? 'selected' : '' }}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
