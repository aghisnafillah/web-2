            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="container mt-4">
                        ...
                        <a href="{{ route('tim_penelitian.create') }}" class="btn btn-primary mb-3">Tambah Anggota
                            Tim</a>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach($timPenelitian as $key => $item)
                                            <tr>
                                                <td>{{ $key + 1 }}</td>
                                                ...
                                                <td>{{ $item->peran }}</td>
                                                <td>
                                                    <a href="{{ route('tim_penelitian.show', $item->id) }}"
                                                        class="btn btn-info btn-sm">Detail</a>
                                                    <a href="{{ route('tim_penelitian.edit', $item->id) }}"
                                                        class="btn btn-warning btn-sm">Edit</a>
                                                    <form action="{{ route('tim_penelitian.destroy', $item->id) }}"
