            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="container mt-4">
                        <h1>Edit Anggota Tim Penelitian</h1>

                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('tim_penelitian.update', $timPenelitian->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="penelitian_id" id="penelitian_id" class="form-control" required>
                                            ...
                                            @foreach($penelitian as $item)
                                                <option value="{{ $item->id }}" {{ $timPenelitian->penelitian_id == $item->id ? 'selected' : '' }}>
                                                    {{ $item->judul }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="dosen_id" id="dosen_id" class="form-control" required>
                                            ...
                                            @foreach($dosen as $item)
                                                <option value="{{ $item->id }}" {{ $timPenelitian->dosen_id == $item->id ? 'selected' : '' }}>
                                                    {{ $item->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="peran" id="peran" class="form-control"
                                            value="{{ $timPenelitian->peran }}" required>
                                    </div>
