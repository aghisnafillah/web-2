                            ...
                            <div class="col-md-6">
                                <div class="card shadow-lg">
                                    <div class="card-header bg-primary text-white">
                                        <h4 class="mb-0">
                                            <i class="fas fa-edit mr-2"></i> Edit Jenis Kegiatan
                                        </h4>
                                    </div>
                                    <div class="card-body">
                                        <form action="{{ route('jenis_kegiatan.update', $jenisKegiatan->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('PUT')

                                            <div class="form-group">
                                                <label for="name" class="font-weight-bold">Nama Jenis Kegiatan</label>
                                                <input type="text"
                                                    class="form-control @error('name') is-invalid @enderror" id="name"
                                                    name="name" value="{{ old('name', $jenisKegiatan->name) }}"
                                            ...
                                            <div class="form-group text-right mt-4">
                                                ...
                                                <a href="{{ route('jenis_kegiatan.index') }}"
