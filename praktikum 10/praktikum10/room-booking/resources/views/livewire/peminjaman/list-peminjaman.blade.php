...
<tr>
<td class="py-2 px-4 border border-gray-300">{{ $p->id
}}</td>
<td class="py-2 px-4 border border-gray-300">{{ $p->pegawai->nama
}}</td>
<td class="py-2 px-4 border border-gray-300">{{ $p->ruang->nama
}}</td>
...
<flux:button variant="danger" wire:click="delete({{ $p->id }})"
