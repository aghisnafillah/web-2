...
<flux:button :href="route('unitkerja.create')" variant="primary">New
...
<tr>
<td class="py-2 px-4 border border-gray-300">{{ $unitkerja->id
}}</td>
<td class="py-2 px-4 border border-gray-300">{{ $unitkerja->kode
}}</td>
<td class="py-2 px-4 border border-gray-300">{{ $unitkerja->nama
}}</td>
